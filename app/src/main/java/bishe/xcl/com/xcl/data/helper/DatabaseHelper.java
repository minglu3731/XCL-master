...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper{
    ...
    private static final String TABLE_NAME = "sqlite-xcl.db";
    ...
    public void onCreate(SQLiteDatabase database,
        ...
        try {
            ...
            TableUtils.createTable(connectionSource, DatePhoto.class);
    ...
    public void onUpgrade(SQLiteDatabase database,
        ...
        try {
            ...
            TableUtils.dropTable(connectionSource, DatePhoto.class, true);
